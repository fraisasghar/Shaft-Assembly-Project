<div align="center">
  ...
  ![Project Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Shaft+Assembly+CAD+Project&fontSize=50&fontColor=ffffff&animation=twinkling&desc=Precision+Engineering+%7C+3D+Modeling+%7C+Mechanical+Design&descSize=20&descAlignY=70)

  [![SolidWorks](https://img.shields.io/badge/CAD-SolidWorks-FF6B35?style=for-the-badge&logo=draft2digital&logoColor=white)](https://www.solidworks.com/)
  [![AutoCAD](https://img.shields.io/badge/CAD-AutoCAD-CA4245?style=for-the-badge&logo=autodesk&logoColor=white)](https://www.autodesk.com/products/autocad)
  [![Mechanical Engineering](https://img.shields.io/badge/Field-Mechanical_Engineering-00599C?style=for-the-badge&logo=gear&logoColor=white)]()
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Tolerances-±0.1mm-blue?style=flat-square" />
  <img src="https://img.shields.io/badge/Components-2-yellow?style=flat-square" />
</div>
...
|---------|---------------|
| Main Flange Diameter | R5.07 |
| Support Hole Spacing | Φ60.07 |
| Shaft Total Length | Φ60.06 |
| Support Height | Φ38.22 |
| End Radius | R0.07 |
| Flat Surface Offset | 0.07 |
...
<div align="center">
  ...
  ![Engineering Principles](https://img.shields.io/badge/ENGINEERING_PRINCIPLES-4A90E2?style=for-the-badge)
  
</div>

| Consideration | Implementation | Benefit |
|---------------|---------------|---------|
| **Stress Distribution** | Rounded corners on support bracket | Prevents cracking under vibration |
| **Manufacturability** | Design optimized for lathe + milling operations | Reduces production time & cost |
| **Material Efficiency** | Balanced geometry between weight and rigidity | Optimal strength-to-weight ratio |
| **Assembly Tolerance** | Proper clearance dimensions | Ensures easy assembly and operation |
